export type DirectorReportDatePreset =
  | "all"
  | "today"
  | "yesterday"
  | "last_7_days"
...
/**
 * Applications means leads converted to Student records.
 * University applications are stored separately in universityApplications.
 */
