...
function addSummary(
  ...
  const summaryRows: Array<[string, string | number]> = [
    ...
    ["Applications (walk-in converted to visa application)", report.summary.applications],
    ...
    ["Walk-in to Visa Application Conversion", `${report.summary.leadToStudentConversionPercentage}%`],
